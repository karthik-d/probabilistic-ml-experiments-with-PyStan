...
'''
observed_data = [{'K':1000, 'theta':0.65, 'N':10}]

#observed_data = [{'isCorrect1':1, 'isCorrect2':0, 'isCorrect3':1}]
...
for data in observed_data:
    result = model.sampling(data=data, algorithm='Fixed_param')
    print(result)
    '''
