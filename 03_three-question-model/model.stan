...
transformed parameters{
    ...
    p_knows = 0.9;
    p_guesses = 0.2;
    likelihoods[1] = bernoulli_lpmf(isCorrect1|p_knows)+bernoulli_lpmf(isCorrect2|p_knows)+bernoulli_lpmf(isCorrect3|p_knows);
    likelihoods[2] = bernoulli_lpmf(isCorrect1|p_knows)+bernoulli_lpmf(isCorrect2|p_guesses)+bernoulli_lpmf(isCorrect3|p_guesses);
    likelihoods[3] = bernoulli_lpmf(isCorrect1|p_guesses)+bernoulli_lpmf(isCorrect2|p_knows)+bernoulli_lpmf(isCorrect3|p_guesses);
    likelihoods[4] = bernoulli_lpmf(isCorrect1|p_guesses)+bernoulli_lpmf(isCorrect2|p_guesses)+bernoulli_lpmf(isCorrect3|p_guesses);
}

model{
    skill1 ~ beta(2,2);   // P(s1)
    skill2 ~ beta(2,2);   // P(s2)
...
generated quantities{
    ...
    print(P_skill1);
    print(log_sum_exp(P_skill1, log_sum_exp(log(1-skill1)+log(skill2)+likelihoods[3], log(1-skill1)+log(1-skill2)+likelihoods[4])));
    ...
    print(P_skill2);
    print(log_sum_exp(P_skill2, log_sum_exp(log(skill1)+log(1-skill2)+likelihoods[2], log(1-skill1)+log(1-skill2)+likelihoods[4])));
